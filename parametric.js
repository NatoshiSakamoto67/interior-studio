...
function frame(t) { if (!running) return; const dt = Math.min(0.05, (t - lastT) / 1000 || 0.016); lastT = t; step(dt); if (liveComposer) liveComposer.render(); else renderer.render(scene, cam); raf = requestAnimationFrame(frame); }
